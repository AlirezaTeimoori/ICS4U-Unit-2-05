...
// As you read the code, you will realize that the code is 
// obvioiusly not written in an standard way in many ways!
// And the reason is this is the first time I am coding 
// something like this, and I have just learned from my
// mistakes (in style of coding, etc.) in this code and I
// will apply it on the next daily assignments, because I 
// really don't have the time to fix all the style issues 
// that are with this code.
